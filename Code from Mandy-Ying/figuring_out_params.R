#What are the parameters of the skew-t that we should use?
...
d = m2( 500, 8, xi, omega2, alpha, nu, p.out=.1, k=2 )
qplot( d$u[1,], d$v[1,] )
d = m2( 500, 8, xi, omega2, alpha, nu, p.out=.1, k=20 )
qplot( d$u[1,], d$v[1,] )
d = m2( 500, 8, xi, omega2, alpha, nu, p.out=.1, k=200 )
qplot( d$u[1,], d$v[1,] )
marg = marginal( xi, omega2, alpha.obs, nu, c(1,9) )
d = m2( 500, 1, marg$xi, marg$omega, marg$alpha, marg$nu, p.out=.05, k=20 )
qplot( d$u, d$v )
